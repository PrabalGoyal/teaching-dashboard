...
df = pd.read_excel(r'C://Users/AsusNK//Data.xlsx')
...
def update_dd_class(selected_teacher):
...
def update_your_avg(selected_teacher, selected_class, selected_section, selected_sub):
...
def update_graph_1(selected_teacher, selected_class, selected_section, selected_sub, selected_sub_slider):
